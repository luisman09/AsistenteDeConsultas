...
lista_join = [('persona', 'centro', 'persona.id_centro = centro.id'),
              ...
              ('celular as c1', 'persona', 'c1.nac = persona.nac AND c1.ci = persona.ci'),
              ('celular as c2', 'persona', 'c2.nac = persona.nac AND c2.ci = persona.ci'),
              ('celular as c5', 'persona', 'c5.nac = persona.nac AND c5.ci = persona.ci'),
              ('email as e1', 'persona', 'e1.nac = persona.nac AND e1.ci = persona.ci'),
              ('email as e2', 'persona', 'e2.nac = persona.nac AND e2.ci = persona.ci'),
              ('email as e5', 'persona', 'e5.nac = persona.nac AND e5.ci = persona.ci'),
              ('fijo as f2', 'persona', 'f2.nac = persona.nac AND f2.ci = persona.ci'),
              ('fijo as f4', 'persona', 'f4.nac = persona.nac AND f4.ci = persona.ci'),
              ('fijo as f5', 'persona', 'f5.nac = persona.nac ANN f5.ci = persona.ci'),
              ('fijo', 'persona', 'fijo.nac = persona.nac AND fijo.ci = persona.ci')
             ]
